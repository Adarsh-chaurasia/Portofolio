...
<h1 className="text-4xl md:text-5xl lg:text-7xl text-white font-bold inter-var text-center mb-44 ">
      ...
      className="rounded-full shadow-xl shadow-gray-800 dark:shadow-gray-800 transition-all duration-300  filter grayscale hover:grayscale-0  sm:max-w-xs md:max-w-sm"
    />
